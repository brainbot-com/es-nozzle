...
project = u'es-nozzle'
copyright = u'2013-2014, brainbot technologies AG'
...
def get_version():
    for line in open(os.path.normpath(os.path.join(__file__, "../../project.clj"))):
        if "defproject" in line:
            return line.split()[-1].strip('"')
    assert "could not determine version"
